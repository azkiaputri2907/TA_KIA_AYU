    ...
    <div class="max-w-2xl w-full bg-white/95 backdrop-blur-md rounded-[2rem] shadow-2xl overflow-hidden border border-white/20">
        ...
        <div class="p-6 md:p-10">
            <div class="bg-blue-50/50 border-2 border-dashed border-blue-200 rounded-2xl p-5 text-center">
                ...
                <p class="text-2xl font-mono font-bold text-pink-600 tracking-wider mt-1">{{ $visit->no_kunjungan }}</p>
                ...
                <div class="grid grid-cols-1 gap-3">
                    <div class="flex items-center p-4 bg-gray-50/80 rounded-xl border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $visit->created_at->translatedFormat('l, d F Y | H:i') }} WIB</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-gray-50/80 rounded-xl border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $visit->nama }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-gray-50/80 rounded-xl border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $visit->nomor_induk ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center p-4 bg-gray-50/80 rounded-xl border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-700">{{ $visit->prodi ?? '-' }}</p>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start p-4 bg-gray-50/80 rounded-xl border border-gray-100">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-semibold text-gray-700 leading-relaxed">{{ $visit->keperluan }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mt-10 flex flex-col sm:flex-row-reverse gap-4">
                <a href="{{ route('guest.survey', $visit->id) }}" 
