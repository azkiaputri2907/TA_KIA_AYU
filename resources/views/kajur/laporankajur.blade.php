...
<div class="flex h-screen bg-[#f8f9fd] overflow-hidden" x-data="{ sideBarOpen: false }">
    ...
    {{-- Pastikan sidebar ini dinamis atau ganti dengan sidebar khusus kajur jika perlu --}}
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden relative">
        ...
        <div class="md:hidden flex items-center justify-between p-4 bg-white shadow-sm z-10">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-lg font-extrabold text-gray-800 leading-tight">Laporan <span class="text-[#a044ff]">Kajur</span></h1>
                    <p class="text-[10px] text-gray-500 font-medium">Analisis data statistik</p>
                </div>
            </div>
        ...
        <div class="flex-1 p-4 md:p-10 overflow-y-auto custom-scrollbar">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <h2 class="text-2xl md:text-3xl font-extrabold text-gray-800 tracking-tight hidden md:block">
                            Laporan & 
                            <span class="text-transparent bg-clip-text bg-gradient-to-r from-[#ff3366] to-[#a044ff]">
                                Statistik
                            </span>
                        </h2>
                        <p class="text-gray-500 text-xs md:text-sm mt-1 hidden md:block">
                            Dashboard Laporan Ketua Jurusan
                        </p>
                    </div>
                </div>
            ...
            <div class="bg-white p-4 md:p-6 rounded-xl md:rounded-[2rem] shadow-sm border border-gray-100 mb-8">
                {{-- PERUBAHAN DISINI: Route diganti menjadi kajur.laporan --}}
                <form action="{{ route('ketua.laporan') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">                    
                    <div>
